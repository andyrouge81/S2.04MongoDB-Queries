...
// 5. Escriu una consulta per mostrar tots els restaurants que estan en el Bronx.
      db.restaurant.find({borough:"Bronx"}, {restaurant_id :1 ,name:1, borough:1,"address.zipcode":1, _id:0});
// 6. Escriu una consulta per mostrar els primers 5 restaurants que estan en el Bronx.
       db.restaurant.find({borough:"Bronx"}, {restaurant_id :1 ,name:1, borough:1,"address.zipcode":1, _id:0}).limit(5);
// 7. Escriu una consulta per mostrar el pròxim 5 restaurants després de saltar els primers 5 del Bronx.
      db.restaurant.find({borough:"Bronx"}, {restaurant_id :1 ,name:1, borough:1,"address.zipcode":1, _id:0}).skip(5).limit(5);
